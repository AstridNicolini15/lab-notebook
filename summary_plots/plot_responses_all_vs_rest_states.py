...
plot_contrast_responses_many_pop_significance_modified(folders, colors, ax_dict["C"], special_dict = special_dict) 
...
plot_contrast_responses_many_pop_significance_modified(folders, colors, ax_dict["D"], special_dict = special_dict) 

#%%


def plot_contrast_responses_many_pop_significance_modified(folders, colors, ax, special_dict = None, summary_path = '/home/user/DATA/Astrid/run_rest_summary') : 
